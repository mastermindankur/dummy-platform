...
"[project]/src/app/pillar/making-design-resilient/jira-assistant-adoption/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname, k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
__turbopack_context__.s({
    "default": (()=>JiraAssistantAdoptionPage)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
...
function JiraAssistantAdoptionPage() {
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "JiraAssistantAdoptionPage.useEffect": ()=>{
            const loadData = {
                "JiraAssistantAdoptionPage.useEffect.loadData": async ()=>{
                    setIsLoading(true);
                    try {
            ...
            }["JiraAssistantAdoptionPage.useEffect.loadData"];
            loadData();
        }
    }["JiraAssistantAdoptionPage.useEffect"], []);
    const { reportData, sortedMonths, totalRow, chartData, platformKeys, testCaseReportData, testCaseTotalRow, testCaseChartData, testCasePlatformKeys } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "JiraAssistantAdoptionPage.useMemo": ()=>{
            if (!monthlyData) {
                return {
                    reportData: [],
                    sortedMonths: [],
            ...
            const sortedMonthLabels = allMonths.map({
                "JiraAssistantAdoptionPage.useMemo.sortedMonthLabels": (m)=>new Date(m + '-02').toLocaleString('default', {
                        month: 'short',
                        year: '2-digit'
                    })
            }["JiraAssistantAdoptionPage.useMemo.sortedMonthLabels"]);
            // USER ADOPTION LOGIC
            const platformMonthlyStats = new Map();
            // TEST CASE ADOPTION LOGIC
            const platformTestCaseStats = new Map();
            for (const month of allMonths){
                const monthLabel = new Date(month + '-02').toLocaleString('default', {
                    month: 'short',
                    'year': '2-digit'
                });
                ...
                for (const row of monthRows){
                    ...
                    if (row['issue_type'] === 'Test') {
                        ...
                        if (!platformDataForTest[monthLabel]) {
                            platformDataForTest[monthLabel] = {
                                totalCases: 0,
                                jaCases: 0
                            };
                        }
            ...
            for (const platform of allPlatformKeys){
                ...
                for (const monthLabel of sortedMonthLabels){
                    ...
                    platformAdoption.monthlyData[monthLabel] = {
            ...
            const reportDataSorted = finalReportData.sort({
                "JiraAssistantAdoptionPage.useMemo.reportDataSorted": (a, b)=>a.platform.localeCompare(b.platform)
            }["JiraAssistantAdoptionPage.useMemo.reportDataSorted"]);
            const grandTotalRow = {
                platform: 'Total',
                monthlyData: {}
            };
            for (const monthLabel of sortedMonthLabels){
                ...
                reportDataSorted.forEach({
                    "JiraAssistantAdoptionPage.useMemo": (p)=>{
            ...
            const chartDataFormatted = sortedMonthLabels.map({
                "JiraAssistantAdoptionPage.useMemo.chartDataFormatted": (month)=>{
                    const monthEntry = {
                        name: month
                    };
                    reportDataSorted.forEach({
                        "JiraAssistantAdoptionPage.useMemo.chartDataFormatted": (platformData)=>{
                            monthEntry[platformData.platform] = platformData.monthlyData[month]?.adoption.toFixed(2);
                        }
                    }["JiraAssistantAdoptionPage.useMemo.chartDataFormatted"]);
                    monthEntry['Total'] = grandTotalRow.monthlyData[month]?.adoption.toFixed(2);
                    return monthEntry;
                }
            }["JiraAssistantAdoptionPage.useMemo.chartDataFormatted"]);
            // Final processing for Test Case Adoption
            const finalTestCaseReportData = [];
            ...
            const testCaseReportDataSorted = finalTestCaseReportData.sort({
                "JiraAssistantAdoptionPage.useMemo.testCaseReportDataSorted": (a, b)=>a.platform.localeCompare(b.platform)
            }["JiraAssistantAdoptionPage.useMemo.testCaseReportDataSorted"]);
            const testCaseGrandTotalRow = {
                platform: 'Total',
                monthlyData: {}
            };
            for (const monthLabel of sortedMonthLabels){
                ...
                testCaseReportDataSorted.forEach({
                    "JiraAssistantAdoptionPage.useMemo": (l)=>{
                ...
                testCaseGrandTotalRow.monthlyData[monthLabel] = {
                    totalCases: totalCasesForMonth,
                    jaCases: jaCasesForMonth,
                    adoption
                };
            }
            const testCaseChartDataFormatted = sortedMonthLabels.map({
                "JiraAssistantAdoptionPage.useMemo.testCaseChartDataFormatted": (month)=>{
                    const monthEntry = {
                        name: month
                    };
                    testCaseReportDataSorted.forEach({
                        "JiraAssistantAdoptionPage.useMemo.testCaseChartDataFormatted": (platformData)=>{
                            monthEntry[platformData.platform] = platformData.monthlyData[month]?.adoption.toFixed(2);
                        }
                    }["JiraAssistantAdoptionPage.useMemo.testCaseChartDataFormatted"]);
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                            ...
                            variant: "outline",
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                href: "/pillar/making-design-resilient",
                                children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                                        children: "Month-on-month adoption percentage."
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/pillar/making-design-resilient/jira-assistant-adoption/page.tsx",
                                                        lineNumber: 291,
                                                        columnNumber: 25
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                                children: [
                                                    isLoading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "flex items-center justify-center p-8 h-[400px]",
                                                    ...
                                                    !isLoading && chartData.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Table"], {
                                                    children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableRow"], {
                                                                    children: [
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableHead"], {
                                                                            className: "min-w-[150px] sticky left-0 bg-secondary",
                                                                            rowSpan: 2,
                                                                            children: "Platform"
                                                                        }, void 0, false, {
                                                                            fileName: "[project]/src/app/pillar/making-design-resilient/jira-assistant-adoption/page.tsx",
                                                                        ...
                                                                        sortedMonths.map((month)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableHead"], {
                                                                                className: "text-center min-w-[300px] border-l",
                                                                                colSpan: 3,
                                                                                children: month
                                                                            }, month, false, {
                                                                                fileName: "[project]/src/app/pillar/making-design-resilient/jira-assistant-adoption/page.tsx",
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableBody"], {
                                                            children: [
                                                                reportData.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableRow"], {
                                                                        children: [
                                                                ...
                                                                totalRow && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableRow"], {
                                                                    className: "font-bold bg-secondary hover:bg-secondary/80",
                                                                    children: [
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                                            className: "sticky left-0 bg-secondary",
                                            ...
                                            !isLoading && testCaseReportData.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Table"], {
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableBody"], {
                                                            children: [
                                                                testCaseReportData.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableRow"], {
                                                                        children: [
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                                                className: "font-medium sticky left-0 bg-background",
                                                                                children: item.platform
...
_s(JiraAssistantAdoptionPage, "SBH8skMwgH+E2VH/SM6iD7ad6IA=");
_c = JiraAssistantAdoptionPage;
var _c;
__turbopack_context__.k.register(_c, "JiraAssistantAdoptionPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_0409c697._.js.map