...
function ExploreResiliencyProgramPage() {
    ...
    const [programSubItem, setProgramSubItem] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ExploreResiliencyProgramPage.useEffect": ()=>{
            const loadData = {
                "ExploreResiliencyProgramPage.useEffect.loadData": async ()=>{
                    setIsLoading(true);
                    try {
                        ...
                        if (pillars) {
                            const emergingTechPillar = pillars.find({
                                "ExploreResiliencyProgramPage.useEffect.loadData.emergingTechPillar": (p)=>p.id === 'adopting-emerging-technologies'
                            }["ExploreResiliencyProgramPage.useEffect.loadData.emergingTechPillar"]);
                            const subItem = emergingTechPillar?.subItems.find({
                                "ExploreResiliencyProgramPage.useEffect.loadData": (s)=>s.id === 'explore-resiliency-program'
                            }["ExploreResiliencyProgramPage.useEffect.loadData"]) || null;
            ...
            }["ExploreResiliencyProgramPage.useEffect.loadData"];
            loadData();
        }
    }["ExploreResiliencyProgramPage.useEffect"], []);
    const { overallStatusData, lobtDistributionData, statusColors, statusList } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ExploreResiliencyProgramPage.useMemo": ()=>{
            if (!excelData?.rows) return {
                overallStatusData: [],
                lobtDistributionData: [],
                statusColors: {},
                statusList: []
            };
            const statusCounts = {};
            const lobtStatusCounts = {};
            const statuses = new Set();
            excelData.rows.forEach({
                "ExploreResiliencyProgramPage.useMemo": (row)=>{
            ...
            const overallStatusData = Object.entries(statusCounts).map({
                "ExploreResiliencyProgramPage.useMemo.overallStatusData": ([name, value])=>({
                        name,
                        value
                    })
            }["ExploreResiliencyProgramPage.useMemo.overallStatusData"]);
            ...
            const statusColors = statusList.reduce({
                "ExploreResiliencyProgramPage.useMemo.statusColors": (acc, status, index)=>{
                    acc[status] = chartColors[index % chartColors.length];
                    return acc;
                }
            }["ExploreResiliencyProgramPage.useMemo.statusColors"], {});
            const lobtDistributionData = Object.entries(lobtStatusCounts).map({
                "ExploreResiliencyProgramPage.useMemo.lobtDistributionData": ([lobt, counts])=>({
                        name: lobt,
                        ...counts
                    })
            }["ExploreResiliencyProgramPage.useMemo.lobtDistributionData"]);
            return {
                overallStatusData,
                lobtDistributionData,
                statusColors,
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                children: [
                                    ...
                                    !isLoading && !excelData && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(ExploreResiliencyProgramPage, "B9HnGc/J+qomOE913e1yO9+q88w=");
...
//# sourceMappingURL=src_9fe990b0._.js.map