...
"[project]/src/app/pillar/adopting-emerging-technologies/tech-sphere-sessions/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname, k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
__turbopack_context__.s({
    "default": (()=>TechSphereSessionsPage)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
...
function TechSphereSessionsPage() {
    _s();
    ...
    const [sessionSubItem, setSessionSubItem] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TechSphereSessionsPage.useEffect": ()=>{
            const loadData = {
                "TechSphereSessionsPage.useEffect.loadData": async ()=>{
                    setIsLoading(true);
                    try {
                        ...
                        if (pillars) {
                            const emergingTechPillar = pillars.find({
                                "TechSphereSessionsPage.useEffect.loadData.emergingTechPillar": (p)=>p.id === 'adopting-emerging-technologies'
                            }["TechSphereSessionsPage.useEffect.loadData.emergingTechPillar"]);
                            const subItem = emergingTechPillar?.subItems.find({
                                "TechSphereSessionsPage.useEffect.loadData": (s)=>s.id === 'tech-sphere-sessions'
                            }["TechSphereSessionsPage.useEffect.loadData"]) || null;
            ...
            }["TechSphereSessionsPage.useEffect.loadData"];
            loadData();
        }
    }["TechSphereSessionsPage.useEffect"], []);
    const { participationData, totalAttendees } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TechSphereSessionsPage.useMemo": ()=>{
            if (!excelData?.rows) return {
                participationData: [],
                totalAttendees: 0
            };
            let total = 0;
            const data = excelData.rows.map({
                "TechSphereSessionsPage.useMemo.data": (row)=>{
                    const attendees = Number(row['Participation']) || 0;
                    total += attendees;
                    return {
                        name: row['Date'],
                        attendees: attendees,
                        title: row['Agenda of Session']
                    };
                }
            }["TechSphereSessionsPage.useMemo.data"]);
            return {
    ...
    const CustomTooltip = ({ active, payload, label })=>{
        if (active && payload && payload.length) {
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "p-2 bg-background border rounded-md shadow-md",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "label",
                        children: `Date: ${label}`
                    }, void 0, false, {
                        fileName: "[project]/src/app/pillar/adopting-emerging-technologies/tech-sphere-sessions/page.tsx",
                        lineNumber: 112,
                        columnNumber: 11
                    }, this),
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "intro",
                        children: `Session: ${payload[0].payload.title}`
                    }, void 0, false, {
                        fileName: "[project]/src/app/pillar/adopting-emerging-technologies/tech-sphere-sessions/page.tsx",
                        lineNumber: 113,
                        columnNumber: 11
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "desc",
                        children: `Participation: ${payload[0].value}`
                    }, void 0, false, {
                        fileName: "[project]/src/app/pillar/adopting-emerging-technologies/tech-sphere-sessions/page.tsx",
                        lineNumber: 114,
                        columnNumber: 11
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                        children: 'This page displays the current data for Tech Sphere Sessions. To update this data, please use the Excel upload feature on the "Update Data" page.'
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/pillar/adopting-emerging-technologies/tech-sphere-sessions/page.tsx",
                                        lineNumber: 139,
                                        columnNumber: 13
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                                                                children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                                                        children: "Audience participation against the annual target."
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/src/app/pillar/adopting-emerging-technologies/tech-sphere-sessions/page.tsx",
                                                                        lineNumber: 162,
                                                                        columnNumber: 29
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardTitle"], {
                                                                        children: "Participation by Session"
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/src/app/pillar/adopting-emerging-technologies/tech-sphere-sessions/page.tsx",
                                                                        lineNumber: 188,
                                                                        columnNumber: 29
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                                                        children: "Number of attendees for each Tech Sphere session."
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/src/app/pillar/adopting-emerging-technologies/tech-sphere-sessions/page.tsx",
                                                                        lineNumber: 189,
                                                                        columnNumber: 29
...
_s(TechSphereSessionsPage, "obDS5b0zAnaz3pp48e1jFDgS3bs=");
_c = TechSphereSessionsPage;
var _c;
__turbopack_context__.k.register(_c, "TechSphereSessionsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_68d76953._.js.map